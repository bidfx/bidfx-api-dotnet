...
namespace BidFX.Public.API.Price.Subject
{
    public class SubjectHelperTest
    {
        ...
        public void CreateLevelOneSpotStreamingSubjectTest()
        {
            ...
            Assert.AreEqual(
                "AssetClass=Fx,BuySideAccount=FX_ACCT,Currency=GBP,DealType=Spot,Level=1,LiquidityProvider=BARC,Quantity=5000000.00,RequestFor=Stream,Symbol=GBPUSD,Tenor=Spot,User=lasman",
                subj.ToString());
        }
        ...
        public void CreateLevelOneSpotQuoteSubjectTest()
        {
            Subject subj = CommonSubjects.CreateLevelOneSpotQuoteSubject("lasman", "FX_ACCT", "EURUSD", "JPMX", "EUR", "10000000.00")
                .CreateSubject();
            Assert.AreEqual(
                "AssetClass=Fx,BuySideAccount=FX_ACCT,Currency=EUR,DealType=Spot,Level=1,LiquidityProvider=JPMX,Quantity=10000000.00,RequestFor=Quote,Symbol=EURUSD,Tenor=Spot,User=lasman",
                subj.ToString());
        }
        ...
        public void CreateLevelTwoSpotStreamingSubjectTest()
        {
            Subject subj = CommonSubjects.CreateLevelTwoSpotStreamingSubject("lasman", "FX_ACCT", "GBPUSD", "GBP", "50000000.00")
                .CreateSubject();
            Assert.AreEqual(
                "AssetClass=Fx,BuySideAccount=FX_ACCT,Currency=GBP,DealType=Spot,Level=2,LiquidityProvider=FXTS,Quantity=50000000.00,RequestFor=Stream,Symbol=GBPUSD,Tenor=Spot,User=lasman",
                subj.ToString());
        }
