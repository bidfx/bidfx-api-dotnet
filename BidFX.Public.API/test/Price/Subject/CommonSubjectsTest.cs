...
namespace BidFX.Public.API.Price.Subject
{
    public class SubjectHelperTest
    {
        ...
        {
            var subj = CommonSubjects.CreateLevelOneSpotStreamingSubject("FX_ACCT", "BARC", "GBPUSD", "GBP", "5000000.00").CreateSubject();
            Assert.AreEqual(
        ...
        {
            var subj = CommonSubjects.CreateLevelOneSpotQuoteSubject("FX_ACCT", "JPMX", "EURUSD", "EUR", "10000000.00").CreateSubject();
            Assert.AreEqual(
        ...
        {
            var subj = CommonSubjects.CreateLevelOneForwardStreamingSubject("FX_ACCT", "BARC", "GBPUSD", "GBP",
        ...
        {
            var subj = CommonSubjects.CreateLevelOneForwardQuoteSubject("FX_ACCT", "BARC", "GBPUSD", "GBP", "1000000.00",
                "20180101").CreateSubject();
            Assert.AreEqual(
        ...
        {
            var subj = CommonSubjects.CreateLevelOneSwapStreamingSubject("FX_ACCT", "BARC", "GBPUSD", "GBP", "1000000.00", "1000000.00",
                "20180101", "20180202").CreateSubject();
            Assert.AreEqual(
        ...
        {
            var subj = CommonSubjects.CreateLevelOneSwapQuoteSubject("FX_ACCT", "BARC", "GBPUSD", "GBP", "1000000.00", "1000000.00",
                "20180101", "20180202").CreateSubject();
            Assert.AreEqual(
